...
# Map to Dwc
  dplyr::mutate(
    ...
    eventID = case_when(
      .data$observationLevel == "event" ~ .data$eventID,
      .data$observationLevel == "media" ~ .data$mediaID
    ),
      .data$eventID,
    ...
    kingdom = "Animalia") %>% 
  dplyr::select(occurrenceID, individualCount, sex, lifeStage, behavior, occurrenceStatus, eventID, identifiedBy,dateIdentified, identificationRemarks, scientificName, kingdom)
```
